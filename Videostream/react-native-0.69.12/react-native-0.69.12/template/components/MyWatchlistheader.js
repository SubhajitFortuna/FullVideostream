...
const WathlistHeader = () => {
  ...
  return (
    ...
    >
      ...
      <Text style={styles.additionalHeaderText}>My Watchlist</Text>
...
const styles = StyleSheet.create({
  ...
  additionalHeaderText: {
    ...
    flex: 1,
    textAlign: "center",
    marginRight: windowWidth * 0.26, // Adjusted margin based on the screen width
  },
});

export default WathlistHeader;
